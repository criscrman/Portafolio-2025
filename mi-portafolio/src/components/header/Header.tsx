...
export const Header = () => {
  return (
    ...
    <div className="main">
      ...
      <div className="layout-container flex  grow flex-col px-4 py-6 sm:px-6 lg:px-8">
         <header>
          <div className="Div1" >
            <div>
          ...
          <div className="div2">
            ...
            <div className="flex gap-2">
              <button
                ...
                title="GitHub"
              >
                <div className="text-[#0d141c]" data-icon="GithubLogo" data-size="20px" data-weight="regular">
